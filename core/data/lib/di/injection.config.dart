...
import 'package:data_store/provider/preferences_provider.dart' as _i812;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<String>(
      () => dataModule.provideAccessToken(gh<_i687.SessionProvider>()),
      instanceName: 'AccessToken',
    );
    gh.factory<String>(
      () => dataModule.provideBaseUrl(gh<_i812.PreferencesProvider>()),
      instanceName: 'BaseUrl',
    );
    gh.factory<String>(
      () => dataModule.provideLanguage(gh<_i812.PreferencesProvider>()),
